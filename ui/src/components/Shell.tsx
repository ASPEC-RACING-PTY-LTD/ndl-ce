    ...
    <div className="shell">
      ...
      <header className="shell-header">
        ...
        <nav className="shell-nav" aria-label="Appliance">
          ...
          <Link href="/automation" aria-current={path === "/automation" ? "page" : undefined}>
            Automation
          </Link>
          ...
          <Link href="/settings/license" aria-current={path === "/settings/license" ? "page" : undefined}>
            License
          </Link>
          <Link href="/docs" aria-current={path === "/docs" ? "page" : undefined}>
            Docs
          </Link>
