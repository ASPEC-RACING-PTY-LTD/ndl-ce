...
export const PALETTE_ACTIONS: PaletteAction[] = [
  ...
  { id: "game-servers", label: "Game Servers", href: "/game-servers", keywords: ["minecraft", "valheim", "fivem", "gmod", "game"] },
  {
    id: "create-game-server",
    label: "Create game server",
    href: "/game-servers/create",
    keywords: ["minecraft", "valheim", "fivem", "game", "server"],
    require: "mutate",
  },
  ...
  { id: "api-access", label: "API Access", href: "/api-access", keywords: ["token", "rest", "service account", "bearer", "api"] },
