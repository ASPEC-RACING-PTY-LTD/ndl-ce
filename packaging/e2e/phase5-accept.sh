...
! grep -q 'CapabilityBoundingSet=~' /lib/systemd/system/ndl-agent.service
! grep -q 'DevicePolicy=auto' /lib/systemd/system/ndl-agent.service
! grep -q 'NoNewPrivileges=no' /lib/systemd/system/ndl-agent.service
