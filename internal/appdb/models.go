...
type Store interface {
	...
	DeleteNetwork(ctx context.Context, clusterID, id string) error
	...
	CreateGameServer(ctx context.Context, s GameServer) error
	GetGameServer(ctx context.Context, clusterID, id string) (*GameServer, error)
	ListGameServers(ctx context.Context, clusterID string) ([]GameServer, error)
	UpdateGameServer(ctx context.Context, s GameServer) error
	DeleteGameServer(ctx context.Context, clusterID, id string) error

	UpsertGameTemplate(ctx context.Context, t GameTemplate) error
	GetGameTemplate(ctx context.Context, clusterID, id string) (*GameTemplate, error)
	ListGameTemplates(ctx context.Context, clusterID string) ([]GameTemplate, error)

	UpsertGameSource(ctx context.Context, s GameSource) error
	ListGameSources(ctx context.Context, clusterID string) ([]GameSource, error)
	DeleteGameSource(ctx context.Context, clusterID, id string) error

	UpsertGameACL(ctx context.Context, a GameACL) error
	ListGameACL(ctx context.Context, serverID string) ([]GameACL, error)
	GetGameACL(ctx context.Context, serverID, userID string) (*GameACL, error)
	DeleteGameACL(ctx context.Context, serverID, userID string) error

	InsertGameEvent(ctx context.Context, e GameEvent) error
	ListGameEvents(ctx context.Context, clusterID, serverID string, limit int) ([]GameEvent, error)

	CreateGameSchedule(ctx context.Context, s GameSchedule) error
	ListGameSchedules(ctx context.Context, serverID string) ([]GameSchedule, error)
	DeleteGameSchedule(ctx context.Context, serverID, id string) error
	UpdateGameSchedule(ctx context.Context, s GameSchedule) error

	CreateGameBackup(ctx context.Context, b GameBackup) error
	ListGameBackups(ctx context.Context, serverID string) ([]GameBackup, error)
	GetGameBackup(ctx context.Context, serverID, id string) (*GameBackup, error)
	DeleteGameBackup(ctx context.Context, serverID, id string) error

	UpsertGameContent(ctx context.Context, c GameContent) error
	ListGameContent(ctx context.Context, serverID string) ([]GameContent, error)
	GetGameContent(ctx context.Context, serverID, id string) (*GameContent, error)
	DeleteGameContent(ctx context.Context, serverID, id string) error

	UpsertGameContentProfile(ctx context.Context, p GameContentProfile) error
	ListGameContentProfiles(ctx context.Context, serverID string) ([]GameContentProfile, error)

	UpsertGameConsoleFav(ctx context.Context, f GameConsoleFav) error
	ListGameConsoleFavs(ctx context.Context, serverID string) ([]GameConsoleFav, error)
	DeleteGameConsoleFav(ctx context.Context, serverID, id string) error

	AppendGameConsoleHist(ctx context.Context, serverID, command string) error
	ListGameConsoleHist(ctx context.Context, serverID string, limit int) ([]string, error)

	GetGameUserPref(ctx context.Context, clusterID, userID, key string) (string, error)
	SetGameUserPref(ctx context.Context, clusterID, userID, key, value string) error
}
