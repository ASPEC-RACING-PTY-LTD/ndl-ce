...
type Memory struct {
	...
	gameSources        map[string]GameSource
	gameACL            map[string]GameACL
	gameEvents         []GameEvent
	gameSchedules      map[string]GameSchedule
	gameBackups        map[string]GameBackup
	gameContent        map[string]GameContent
	gameProfiles       map[string]GameContentProfile
	gameFavs           map[string]GameConsoleFav
	gameHist           map[string][]string
	gamePrefs          map[string]string
}
