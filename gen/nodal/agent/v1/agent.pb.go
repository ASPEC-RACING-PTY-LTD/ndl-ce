...
const file_nodal_agent_v1_agent_proto_rawDesc = "" +
	...
	"\fnetwork_json\x18\x01 \x01(\fR\vnetworkJson\"\xe7\t\n" +
	...
	"\bzfs_pool\x18\x1b \x01(\v2\x17.nodal.agent.v1.ZFSPoolH\x00R\azfsPoolB\b\n" +
	"\x06method\"\xb9\x01\n" +
	"\n" +
	"HostUpdate\x12\x16\n" +
	...
	"\tdest_path\x18\f \x01(\tR\bdestPath\"b\n" +
	"\n" +
	"BackupCopy\x12\x16\n" +
...
var file_nodal_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_nodal_agent_v1_agent_proto_goTypes = []any{
	...
	(*BackupCopy)(nil),            // 23: nodal.agent.v1.BackupCopy
	(*VMSnapshot)(nil),            // 24: nodal.agent.v1.VMSnapshot
	(*VMPrepare)(nil),             // 25: nodal.agent.v1.VMPrepare
	(*VMLifecycle)(nil),           // 26: nodal.agent.v1.VMLifecycle
	(*VMQueryPCI)(nil),            // 27: nodal.agent.v1.VMQueryPCI
	(*QemuProtoStart)(nil),        // 28: nodal.agent.v1.QemuProtoStart
	(*QemuProtoStop)(nil),         // 29: nodal.agent.v1.QemuProtoStop
	(*QemuProtoStatus)(nil),       // 30: nodal.agent.v1.QemuProtoStatus
	(*CTCreate)(nil),              // 31: nodal.agent.v1.CTCreate
	(*CTLifecycle)(nil),           // 32: nodal.agent.v1.CTLifecycle
	(*WorkloadHint)(nil),          // 33: nodal.agent.v1.WorkloadHint
	(*Ping)(nil),                  // 34: nodal.agent.v1.Ping
	(*CreateDirectoryPool)(nil),   // 35: nodal.agent.v1.CreateDirectoryPool
	(*CreateDirectoryVolume)(nil), // 36: nodal.agent.v1.CreateDirectoryVolume
	(*NetDryRun)(nil),             // 37: nodal.agent.v1.NetDryRun
	(*NetApply)(nil),              // 38: nodal.agent.v1.NetApply
	(*ExecuteResponse)(nil),       // 39: nodal.agent.v1.ExecuteResponse
	(*UploadLibraryRequest)(nil),  // 40: nodal.agent.v1.UploadLibraryRequest
	(*UploadLibraryBegin)(nil),    // 41: nodal.agent.v1.UploadLibraryBegin
	(*UploadLibraryFinish)(nil),   // 42: nodal.agent.v1.UploadLibraryFinish
	(*UploadLibraryResponse)(nil), // 43: nodal.agent.v1.UploadLibraryResponse
	(*EnrollRequest)(nil),         // 44: nodal.agent.v1.EnrollRequest
	(*EnrollResponse)(nil),        // 45: nodal.agent.v1.EnrollResponse
	(*OpenSessionRequest)(nil),    // 46: nodal.agent.v1.OpenSessionRequest
	(*OpenSessionResponse)(nil),   // 47: nodal.agent.v1.OpenSessionResponse
	(*FilesOpRequest)(nil),        // 48: nodal.agent.v1.FilesOpRequest
	(*FilesOpResponse)(nil),       // 49: nodal.agent.v1.FilesOpResponse
	(*FilesPutRequest)(nil),       // 50: nodal.agent.v1.FilesPutRequest
	(*FilesPutBegin)(nil),         // 51: nodal.agent.v1.FilesPutBegin
	(*FilesPutFinish)(nil),        // 52: nodal.agent.v1.FilesPutFinish
	(*FilesGetRequest)(nil),       // 53: nodal.agent.v1.FilesGetRequest
	(*FilesGetResponse)(nil),      // 54: nodal.agent.v1.FilesGetResponse
	(*TermFrame)(nil),             // 55: nodal.agent.v1.TermFrame
}
var file_nodal_agent_v1_agent_proto_depIdxs = []int32{
	...
	33, // 3: nodal.agent.v1.ObserveRequest.workloads:type_name -> nodal.agent.v1.WorkloadHint
	33, // 4: nodal.agent.v1.GetWorkloadsRequest.workloads:type_name -> nodal.agent.v1.WorkloadHint
	...
	34, // 7: nodal.agent.v1.ExecuteRequest.ping:type_name -> nodal.agent.v1.Ping
	35, // 8: nodal.agent.v1.ExecuteRequest.create_directory_pool:type_name -> nodal.agent.v1.CreateDirectoryPool
	36, // 9: nodal.agent.v1.ExecuteRequest.create_directory_volume:type_name -> nodal.agent.v1.CreateDirectoryVolume
	37, // 10: nodal.agent.v1.ExecuteRequest.net_dry_run:type_name -> nodal.agent.v1.NetDryRun
	38, // 11: nodal.agent.v1.ExecuteRequest.net_apply:type_name -> nodal.agent.v1.NetApply
	31, // 12: nodal.agent.v1.ExecuteRequest.ct_create:type_name -> nodal.agent.v1.CTCreate
	32, // 13: nodal.agent.v1.ExecuteRequest.ct_lifecycle:type_name -> nodal.agent.v1.CTLifecycle
	28, // 14: nodal.agent.v1.ExecuteRequest.qemu_proto_start:type_name -> nodal.agent.v1.QemuProtoStart
	29, // 15: nodal.agent.v1.ExecuteRequest.qemu_proto_stop:type_name -> nodal.agent.v1.QemuProtoStop
	30, // 16: nodal.agent.v1.ExecuteRequest.qemu_proto_status:type_name -> nodal.agent.v1.QemuProtoStatus
	25, // 17: nodal.agent.v1.ExecuteRequest.vm_prepare:type_name -> nodal.agent.v1.VMPrepare
	26, // 18: nodal.agent.v1.ExecuteRequest.vm_lifecycle:type_name -> nodal.agent.v1.VMLifecycle
	27, // 19: nodal.agent.v1.ExecuteRequest.vm_query_pci:type_name -> nodal.agent.v1.VMQueryPCI
	24, // 20: nodal.agent.v1.ExecuteRequest.vm_snapshot:type_name -> nodal.agent.v1.VMSnapshot
	23, // 21: nodal.agent.v1.ExecuteRequest.backup_copy:type_name -> nodal.agent.v1.BackupCopy
	...
	41, // 25: nodal.agent.v1.UploadLibraryRequest.begin:type_name -> nodal.agent.v1.UploadLibraryBegin
	42, // 26: nodal.agent.v1.UploadLibraryRequest.finish:type_name -> nodal.agent.v1.UploadLibraryFinish
	0,  // 27: nodal.agent.v1.EnrollResponse.host_platform:type_name -> nodal.agent.v1.HostPlatform
	51, // 28: nodal.agent.v1.FilesPutRequest.begin:type_name -> nodal.agent.v1.FilesPutBegin
	52, // 29: nodal.agent.v1.FilesPutRequest.finish:type_name -> nodal.agent.v1.FilesPutFinish
	1,  // 30: nodal.agent.v1.AgentService.Hello:input_type -> nodal.agent.v1.HelloRequest
	5,  // 31: nodal.agent.v1.AgentService.Observe:input_type -> nodal.agent.v1.ObserveRequest
	19, // 32: nodal.agent.v1.AgentService.Execute:input_type -> nodal.agent.v1.ExecuteRequest
	44, // 33: nodal.agent.v1.AgentService.Enroll:input_type -> nodal.agent.v1.EnrollRequest
	46, // 34: nodal.agent.v1.AgentService.OpenSession:input_type -> nodal.agent.v1.OpenSessionRequest
	9,  // 35: nodal.agent.v1.AgentService.GetInventory:input_type -> nodal.agent.v1.GetInventoryRequest
	11, // 36: nodal.agent.v1.AgentService.GetMetrics:input_type -> nodal.agent.v1.GetMetricsRequest
	13, // 37: nodal.agent.v1.AgentService.GetLogs:input_type -> nodal.agent.v1.GetLogsRequest
	15, // 38: nodal.agent.v1.AgentService.GetStorage:input_type -> nodal.agent.v1.GetStorageRequest
	17, // 39: nodal.agent.v1.AgentService.GetNetworks:input_type -> nodal.agent.v1.GetNetworksRequest
	7,  // 40: nodal.agent.v1.AgentService.GetWorkloads:input_type -> nodal.agent.v1.GetWorkloadsRequest
	40, // 41: nodal.agent.v1.AgentService.UploadLibrary:input_type -> nodal.agent.v1.UploadLibraryRequest
	48, // 42: nodal.agent.v1.AgentService.FilesOp:input_type -> nodal.agent.v1.FilesOpRequest
	50, // 43: nodal.agent.v1.AgentService.FilesPut:input_type -> nodal.agent.v1.FilesPutRequest
	53, // 44: nodal.agent.v1.AgentService.FilesGet:input_type -> nodal.agent.v1.FilesGetRequest
	55, // 45: nodal.agent.v1.AgentService.AttachTerminal:input_type -> nodal.agent.v1.TermFrame
	2,  // 46: nodal.agent.v1.AgentService.Hello:output_type -> nodal.agent.v1.HelloResponse
	6,  // 47: nodal.agent.v1.AgentService.Observe:output_type -> nodal.agent.v1.ObserveResponse
	39, // 48: nodal.agent.v1.AgentService.Execute:output_type -> nodal.agent.v1.ExecuteResponse
	45, // 49: nodal.agent.v1.AgentService.Enroll:output_type -> nodal.agent.v1.EnrollResponse
	47, // 50: nodal.agent.v1.AgentService.OpenSession:output_type -> nodal.agent.v1.OpenSessionResponse
	10, // 51: nodal.agent.v1.AgentService.GetInventory:output_type -> nodal.agent.v1.GetInventoryResponse
	12, // 52: nodal.agent.v1.AgentService.GetMetrics:output_type -> nodal.agent.v1.GetMetricsResponse
	14, // 53: nodal.agent.v1.AgentService.GetLogs:output_type -> nodal.agent.v1.GetLogsResponse
	16, // 54: nodal.agent.v1.AgentService.GetStorage:output_type -> nodal.agent.v1.GetStorageResponse
	18, // 55: nodal.agent.v1.AgentService.GetNetworks:output_type -> nodal.agent.v1.GetNetworksResponse
	8,  // 56: nodal.agent.v1.AgentService.GetWorkloads:output_type -> nodal.agent.v1.GetWorkloadsResponse
	43, // 57: nodal.agent.v1.AgentService.UploadLibrary:output_type -> nodal.agent.v1.UploadLibraryResponse
	49, // 58: nodal.agent.v1.AgentService.FilesOp:output_type -> nodal.agent.v1.FilesOpResponse
	49, // 59: nodal.agent.v1.AgentService.FilesPut:output_type -> nodal.agent.v1.FilesOpResponse
	54, // 60: nodal.agent.v1.AgentService.FilesGet:output_type -> nodal.agent.v1.FilesGetResponse
	55, // 61: nodal.agent.v1.AgentService.AttachTerminal:output_type -> nodal.agent.v1.TermFrame
...
func file_nodal_agent_v1_agent_proto_init() {
	...
	file_nodal_agent_v1_agent_proto_msgTypes[40].OneofWrappers = []any{
		(*UploadLibraryRequest_Begin)(nil),
		(*UploadLibraryRequest_Chunk)(nil),
		(*UploadLibraryRequest_Finish)(nil),
	}
	file_nodal_agent_v1_agent_proto_msgTypes[50].OneofWrappers = []any{
