...
const file_nodal_agent_v1_agent_proto_rawDesc = "" +
	...
	"\fnetwork_json\x18\x01 \x01(\fR\vnetworkJson\"\xb1\t\n" +
	...
	"hostUpdate\x12:\n" +
	"\n" +
	"gpu_assign\x18\x1a \x01(\v2\x19.nodal.agent.v1.GPUAssignH\x00R\tgpuAssignB\b\n" +
	"\x06method\"\xb9\x01\n" +
	"\n" +
	"HostUpdate\x12\x16\n" +
	...
	"\adry_run\x18\t \x01(\bR\x06dryRun\"b\n" +
	"\n" +
	"BackupCopy\x12\x16\n" +
...
var file_nodal_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_nodal_agent_v1_agent_proto_goTypes = []any{
	...
	(*BackupCopy)(nil),            // 20: nodal.agent.v1.BackupCopy
	(*VMSnapshot)(nil),            // 21: nodal.agent.v1.VMSnapshot
	(*VMPrepare)(nil),             // 22: nodal.agent.v1.VMPrepare
	(*VMLifecycle)(nil),           // 23: nodal.agent.v1.VMLifecycle
	(*VMQueryPCI)(nil),            // 24: nodal.agent.v1.VMQueryPCI
	(*QemuProtoStart)(nil),        // 25: nodal.agent.v1.QemuProtoStart
	(*QemuProtoStop)(nil),         // 26: nodal.agent.v1.QemuProtoStop
	(*QemuProtoStatus)(nil),       // 27: nodal.agent.v1.QemuProtoStatus
	(*CTCreate)(nil),              // 28: nodal.agent.v1.CTCreate
	(*CTLifecycle)(nil),           // 29: nodal.agent.v1.CTLifecycle
	(*WorkloadHint)(nil),          // 30: nodal.agent.v1.WorkloadHint
	(*Ping)(nil),                  // 31: nodal.agent.v1.Ping
	(*CreateDirectoryPool)(nil),   // 32: nodal.agent.v1.CreateDirectoryPool
	(*CreateDirectoryVolume)(nil), // 33: nodal.agent.v1.CreateDirectoryVolume
	(*NetDryRun)(nil),             // 34: nodal.agent.v1.NetDryRun
	(*NetApply)(nil),              // 35: nodal.agent.v1.NetApply
	(*ExecuteResponse)(nil),       // 36: nodal.agent.v1.ExecuteResponse
	(*UploadLibraryRequest)(nil),  // 37: nodal.agent.v1.UploadLibraryRequest
	(*UploadLibraryBegin)(nil),    // 38: nodal.agent.v1.UploadLibraryBegin
	(*UploadLibraryFinish)(nil),   // 39: nodal.agent.v1.UploadLibraryFinish
	(*UploadLibraryResponse)(nil), // 40: nodal.agent.v1.UploadLibraryResponse
	(*EnrollRequest)(nil),         // 41: nodal.agent.v1.EnrollRequest
	(*EnrollResponse)(nil),        // 42: nodal.agent.v1.EnrollResponse
	(*OpenSessionRequest)(nil),    // 43: nodal.agent.v1.OpenSessionRequest
	(*OpenSessionResponse)(nil),   // 44: nodal.agent.v1.OpenSessionResponse
	(*FilesOpRequest)(nil),        // 45: nodal.agent.v1.FilesOpRequest
	(*FilesOpResponse)(nil),       // 46: nodal.agent.v1.FilesOpResponse
	(*FilesPutRequest)(nil),       // 47: nodal.agent.v1.FilesPutRequest
	(*FilesPutBegin)(nil),         // 48: nodal.agent.v1.FilesPutBegin
	(*FilesPutFinish)(nil),        // 49: nodal.agent.v1.FilesPutFinish
	(*FilesGetRequest)(nil),       // 50: nodal.agent.v1.FilesGetRequest
	(*FilesGetResponse)(nil),      // 51: nodal.agent.v1.FilesGetResponse
	(*TermFrame)(nil),             // 52: nodal.agent.v1.TermFrame
}
var file_nodal_agent_v1_agent_proto_depIdxs = []int32{
	...
	30, // 3: nodal.agent.v1.ObserveRequest.workloads:type_name -> nodal.agent.v1.WorkloadHint
	30, // 4: nodal.agent.v1.GetWorkloadsRequest.workloads:type_name -> nodal.agent.v1.WorkloadHint
	...
	31, // 7: nodal.agent.v1.ExecuteRequest.ping:type_name -> nodal.agent.v1.Ping
	32, // 8: nodal.agent.v1.ExecuteRequest.create_directory_pool:type_name -> nodal.agent.v1.CreateDirectoryPool
	33, // 9: nodal.agent.v1.ExecuteRequest.create_directory_volume:type_name -> nodal.agent.v1.CreateDirectoryVolume
	34, // 10: nodal.agent.v1.ExecuteRequest.net_dry_run:type_name -> nodal.agent.v1.NetDryRun
	35, // 11: nodal.agent.v1.ExecuteRequest.net_apply:type_name -> nodal.agent.v1.NetApply
	28, // 12: nodal.agent.v1.ExecuteRequest.ct_create:type_name -> nodal.agent.v1.CTCreate
	29, // 13: nodal.agent.v1.ExecuteRequest.ct_lifecycle:type_name -> nodal.agent.v1.CTLifecycle
	25, // 14: nodal.agent.v1.ExecuteRequest.qemu_proto_start:type_name -> nodal.agent.v1.QemuProtoStart
	26, // 15: nodal.agent.v1.ExecuteRequest.qemu_proto_stop:type_name -> nodal.agent.v1.QemuProtoStop
	27, // 16: nodal.agent.v1.ExecuteRequest.qemu_proto_status:type_name -> nodal.agent.v1.QemuProtoStatus
	22, // 17: nodal.agent.v1.ExecuteRequest.vm_prepare:type_name -> nodal.agent.v1.VMPrepare
	23, // 18: nodal.agent.v1.ExecuteRequest.vm_lifecycle:type_name -> nodal.agent.v1.VMLifecycle
	24, // 19: nodal.agent.v1.ExecuteRequest.vm_query_pci:type_name -> nodal.agent.v1.VMQueryPCI
	21, // 20: nodal.agent.v1.ExecuteRequest.vm_snapshot:type_name -> nodal.agent.v1.VMSnapshot
	20, // 21: nodal.agent.v1.ExecuteRequest.backup_copy:type_name -> nodal.agent.v1.BackupCopy
	...
	38, // 24: nodal.agent.v1.UploadLibraryRequest.begin:type_name -> nodal.agent.v1.UploadLibraryBegin
	39, // 25: nodal.agent.v1.UploadLibraryRequest.finish:type_name -> nodal.agent.v1.UploadLibraryFinish
	0,  // 26: nodal.agent.v1.EnrollResponse.host_platform:type_name -> nodal.agent.v1.HostPlatform
	48, // 27: nodal.agent.v1.FilesPutRequest.begin:type_name -> nodal.agent.v1.FilesPutBegin
	49, // 28: nodal.agent.v1.FilesPutRequest.finish:type_name -> nodal.agent.v1.FilesPutFinish
	1,  // 29: nodal.agent.v1.AgentService.Hello:input_type -> nodal.agent.v1.HelloRequest
	5,  // 30: nodal.agent.v1.AgentService.Observe:input_type -> nodal.agent.v1.ObserveRequest
	17, // 31: nodal.agent.v1.AgentService.Execute:input_type -> nodal.agent.v1.ExecuteRequest
	41, // 32: nodal.agent.v1.AgentService.Enroll:input_type -> nodal.agent.v1.EnrollRequest
	43, // 33: nodal.agent.v1.AgentService.OpenSession:input_type -> nodal.agent.v1.OpenSessionRequest
	9,  // 34: nodal.agent.v1.AgentService.GetInventory:input_type -> nodal.agent.v1.GetInventoryRequest
	11, // 35: nodal.agent.v1.AgentService.GetMetrics:input_type -> nodal.agent.v1.GetMetricsRequest
	13, // 36: nodal.agent.v1.AgentService.GetStorage:input_type -> nodal.agent.v1.GetStorageRequest
	15, // 37: nodal.agent.v1.AgentService.GetNetworks:input_type -> nodal.agent.v1.GetNetworksRequest
	7,  // 38: nodal.agent.v1.AgentService.GetWorkloads:input_type -> nodal.agent.v1.GetWorkloadsRequest
	37, // 39: nodal.agent.v1.AgentService.UploadLibrary:input_type -> nodal.agent.v1.UploadLibraryRequest
	45, // 40: nodal.agent.v1.AgentService.FilesOp:input_type -> nodal.agent.v1.FilesOpRequest
	47, // 41: nodal.agent.v1.AgentService.FilesPut:input_type -> nodal.agent.v1.FilesPutRequest
	50, // 42: nodal.agent.v1.AgentService.FilesGet:input_type -> nodal.agent.v1.FilesGetRequest
	52, // 43: nodal.agent.v1.AgentService.AttachTerminal:input_type -> nodal.agent.v1.TermFrame
	2,  // 44: nodal.agent.v1.AgentService.Hello:output_type -> nodal.agent.v1.HelloResponse
	6,  // 45: nodal.agent.v1.AgentService.Observe:output_type -> nodal.agent.v1.ObserveResponse
	36, // 46: nodal.agent.v1.AgentService.Execute:output_type -> nodal.agent.v1.ExecuteResponse
	42, // 47: nodal.agent.v1.AgentService.Enroll:output_type -> nodal.agent.v1.EnrollResponse
	44, // 48: nodal.agent.v1.AgentService.OpenSession:output_type -> nodal.agent.v1.OpenSessionResponse
	10, // 49: nodal.agent.v1.AgentService.GetInventory:output_type -> nodal.agent.v1.GetInventoryResponse
	12, // 50: nodal.agent.v1.AgentService.GetMetrics:output_type -> nodal.agent.v1.GetMetricsResponse
	14, // 51: nodal.agent.v1.AgentService.GetStorage:output_type -> nodal.agent.v1.GetStorageResponse
	16, // 52: nodal.agent.v1.AgentService.GetNetworks:output_type -> nodal.agent.v1.GetNetworksResponse
	8,  // 53: nodal.agent.v1.AgentService.GetWorkloads:output_type -> nodal.agent.v1.GetWorkloadsResponse
	40, // 54: nodal.agent.v1.AgentService.UploadLibrary:output_type -> nodal.agent.v1.UploadLibraryResponse
	46, // 55: nodal.agent.v1.AgentService.FilesOp:output_type -> nodal.agent.v1.FilesOpResponse
	46, // 56: nodal.agent.v1.AgentService.FilesPut:output_type -> nodal.agent.v1.FilesOpResponse
	51, // 57: nodal.agent.v1.AgentService.FilesGet:output_type -> nodal.agent.v1.FilesGetResponse
	52, // 58: nodal.agent.v1.AgentService.AttachTerminal:output_type -> nodal.agent.v1.TermFrame
