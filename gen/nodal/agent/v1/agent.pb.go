...
const file_nodal_agent_v1_agent_proto_rawDesc = "" +
	...
	"\fnetwork_json\x18\x01 \x01(\fR\vnetworkJson\"\xb6\b\n" +
...
var file_nodal_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_nodal_agent_v1_agent_proto_goTypes = []any{
	...
	(*BackupCopy)(nil),            // 18: nodal.agent.v1.BackupCopy
	(*VMSnapshot)(nil),            // 19: nodal.agent.v1.VMSnapshot
	(*VMPrepare)(nil),             // 20: nodal.agent.v1.VMPrepare
	(*VMLifecycle)(nil),           // 21: nodal.agent.v1.VMLifecycle
	(*VMQueryPCI)(nil),            // 22: nodal.agent.v1.VMQueryPCI
	(*QemuProtoStart)(nil),        // 23: nodal.agent.v1.QemuProtoStart
	(*QemuProtoStop)(nil),         // 24: nodal.agent.v1.QemuProtoStop
	(*QemuProtoStatus)(nil),       // 25: nodal.agent.v1.QemuProtoStatus
	(*CTCreate)(nil),              // 26: nodal.agent.v1.CTCreate
	(*CTLifecycle)(nil),           // 27: nodal.agent.v1.CTLifecycle
	(*WorkloadHint)(nil),          // 28: nodal.agent.v1.WorkloadHint
	(*Ping)(nil),                  // 29: nodal.agent.v1.Ping
	(*CreateDirectoryPool)(nil),   // 30: nodal.agent.v1.CreateDirectoryPool
	(*CreateDirectoryVolume)(nil), // 31: nodal.agent.v1.CreateDirectoryVolume
	(*NetDryRun)(nil),             // 32: nodal.agent.v1.NetDryRun
	(*NetApply)(nil),              // 33: nodal.agent.v1.NetApply
	(*ExecuteResponse)(nil),       // 34: nodal.agent.v1.ExecuteResponse
	(*UploadLibraryRequest)(nil),  // 35: nodal.agent.v1.UploadLibraryRequest
	(*UploadLibraryBegin)(nil),    // 36: nodal.agent.v1.UploadLibraryBegin
	(*UploadLibraryFinish)(nil),   // 37: nodal.agent.v1.UploadLibraryFinish
	(*UploadLibraryResponse)(nil), // 38: nodal.agent.v1.UploadLibraryResponse
	(*EnrollRequest)(nil),         // 39: nodal.agent.v1.EnrollRequest
	(*EnrollResponse)(nil),        // 40: nodal.agent.v1.EnrollResponse
	(*OpenSessionRequest)(nil),    // 41: nodal.agent.v1.OpenSessionRequest
	(*OpenSessionResponse)(nil),   // 42: nodal.agent.v1.OpenSessionResponse
	(*FilesOpRequest)(nil),        // 43: nodal.agent.v1.FilesOpRequest
	(*FilesOpResponse)(nil),       // 44: nodal.agent.v1.FilesOpResponse
	(*FilesPutRequest)(nil),       // 45: nodal.agent.v1.FilesPutRequest
	(*FilesPutBegin)(nil),         // 46: nodal.agent.v1.FilesPutBegin
	(*FilesPutFinish)(nil),        // 47: nodal.agent.v1.FilesPutFinish
	(*FilesGetRequest)(nil),       // 48: nodal.agent.v1.FilesGetRequest
	(*FilesGetResponse)(nil),      // 49: nodal.agent.v1.FilesGetResponse
	(*TermFrame)(nil),             // 50: nodal.agent.v1.TermFrame
}
var file_nodal_agent_v1_agent_proto_depIdxs = []int32{
	...
	28, // 3: nodal.agent.v1.ObserveRequest.workloads:type_name -> nodal.agent.v1.WorkloadHint
	28, // 4: nodal.agent.v1.GetWorkloadsRequest.workloads:type_name -> nodal.agent.v1.WorkloadHint
	...
	29, // 7: nodal.agent.v1.ExecuteRequest.ping:type_name -> nodal.agent.v1.Ping
	30, // 8: nodal.agent.v1.ExecuteRequest.create_directory_pool:type_name -> nodal.agent.v1.CreateDirectoryPool
	31, // 9: nodal.agent.v1.ExecuteRequest.create_directory_volume:type_name -> nodal.agent.v1.CreateDirectoryVolume
	32, // 10: nodal.agent.v1.ExecuteRequest.net_dry_run:type_name -> nodal.agent.v1.NetDryRun
	33, // 11: nodal.agent.v1.ExecuteRequest.net_apply:type_name -> nodal.agent.v1.NetApply
	26, // 12: nodal.agent.v1.ExecuteRequest.ct_create:type_name -> nodal.agent.v1.CTCreate
	27, // 13: nodal.agent.v1.ExecuteRequest.ct_lifecycle:type_name -> nodal.agent.v1.CTLifecycle
	23, // 14: nodal.agent.v1.ExecuteRequest.qemu_proto_start:type_name -> nodal.agent.v1.QemuProtoStart
	24, // 15: nodal.agent.v1.ExecuteRequest.qemu_proto_stop:type_name -> nodal.agent.v1.QemuProtoStop
	25, // 16: nodal.agent.v1.ExecuteRequest.qemu_proto_status:type_name -> nodal.agent.v1.QemuProtoStatus
	20, // 17: nodal.agent.v1.ExecuteRequest.vm_prepare:type_name -> nodal.agent.v1.VMPrepare
	21, // 18: nodal.agent.v1.ExecuteRequest.vm_lifecycle:type_name -> nodal.agent.v1.VMLifecycle
	22, // 19: nodal.agent.v1.ExecuteRequest.vm_query_pci:type_name -> nodal.agent.v1.VMQueryPCI
	19, // 20: nodal.agent.v1.ExecuteRequest.vm_snapshot:type_name -> nodal.agent.v1.VMSnapshot
	18, // 21: nodal.agent.v1.ExecuteRequest.backup_copy:type_name -> nodal.agent.v1.BackupCopy
	36, // 22: nodal.agent.v1.UploadLibraryRequest.begin:type_name -> nodal.agent.v1.UploadLibraryBegin
	37, // 23: nodal.agent.v1.UploadLibraryRequest.finish:type_name -> nodal.agent.v1.UploadLibraryFinish
	0,  // 24: nodal.agent.v1.EnrollResponse.host_platform:type_name -> nodal.agent.v1.HostPlatform
	46, // 25: nodal.agent.v1.FilesPutRequest.begin:type_name -> nodal.agent.v1.FilesPutBegin
	47, // 26: nodal.agent.v1.FilesPutRequest.finish:type_name -> nodal.agent.v1.FilesPutFinish
	1,  // 27: nodal.agent.v1.AgentService.Hello:input_type -> nodal.agent.v1.HelloRequest
	5,  // 28: nodal.agent.v1.AgentService.Observe:input_type -> nodal.agent.v1.ObserveRequest
	17, // 29: nodal.agent.v1.AgentService.Execute:input_type -> nodal.agent.v1.ExecuteRequest
	39, // 30: nodal.agent.v1.AgentService.Enroll:input_type -> nodal.agent.v1.EnrollRequest
	41, // 31: nodal.agent.v1.AgentService.OpenSession:input_type -> nodal.agent.v1.OpenSessionRequest
	9,  // 32: nodal.agent.v1.AgentService.GetInventory:input_type -> nodal.agent.v1.GetInventoryRequest
	11, // 33: nodal.agent.v1.AgentService.GetMetrics:input_type -> nodal.agent.v1.GetMetricsRequest
	13, // 34: nodal.agent.v1.AgentService.GetStorage:input_type -> nodal.agent.v1.GetStorageRequest
	15, // 35: nodal.agent.v1.AgentService.GetNetworks:input_type -> nodal.agent.v1.GetNetworksRequest
	7,  // 36: nodal.agent.v1.AgentService.GetWorkloads:input_type -> nodal.agent.v1.GetWorkloadsRequest
	35, // 37: nodal.agent.v1.AgentService.UploadLibrary:input_type -> nodal.agent.v1.UploadLibraryRequest
	43, // 38: nodal.agent.v1.AgentService.FilesOp:input_type -> nodal.agent.v1.FilesOpRequest
	45, // 39: nodal.agent.v1.AgentService.FilesPut:input_type -> nodal.agent.v1.FilesPutRequest
	48, // 40: nodal.agent.v1.AgentService.FilesGet:input_type -> nodal.agent.v1.FilesGetRequest
	50, // 41: nodal.agent.v1.AgentService.AttachTerminal:input_type -> nodal.agent.v1.TermFrame
	2,  // 42: nodal.agent.v1.AgentService.Hello:output_type -> nodal.agent.v1.HelloResponse
	6,  // 43: nodal.agent.v1.AgentService.Observe:output_type -> nodal.agent.v1.ObserveResponse
	34, // 44: nodal.agent.v1.AgentService.Execute:output_type -> nodal.agent.v1.ExecuteResponse
	40, // 45: nodal.agent.v1.AgentService.Enroll:output_type -> nodal.agent.v1.EnrollResponse
	42, // 46: nodal.agent.v1.AgentService.OpenSession:output_type -> nodal.agent.v1.OpenSessionResponse
	10, // 47: nodal.agent.v1.AgentService.GetInventory:output_type -> nodal.agent.v1.GetInventoryResponse
	12, // 48: nodal.agent.v1.AgentService.GetMetrics:output_type -> nodal.agent.v1.GetMetricsResponse
	14, // 49: nodal.agent.v1.AgentService.GetStorage:output_type -> nodal.agent.v1.GetStorageResponse
	16, // 50: nodal.agent.v1.AgentService.GetNetworks:output_type -> nodal.agent.v1.GetNetworksResponse
	8,  // 51: nodal.agent.v1.AgentService.GetWorkloads:output_type -> nodal.agent.v1.GetWorkloadsResponse
	38, // 52: nodal.agent.v1.AgentService.UploadLibrary:output_type -> nodal.agent.v1.UploadLibraryResponse
	44, // 53: nodal.agent.v1.AgentService.FilesOp:output_type -> nodal.agent.v1.FilesOpResponse
	44, // 54: nodal.agent.v1.AgentService.FilesPut:output_type -> nodal.agent.v1.FilesOpResponse
	49, // 55: nodal.agent.v1.AgentService.FilesGet:output_type -> nodal.agent.v1.FilesGetResponse
	50, // 56: nodal.agent.v1.AgentService.AttachTerminal:output_type -> nodal.agent.v1.TermFrame
...
func file_nodal_agent_v1_agent_proto_init() {
	...
	file_nodal_agent_v1_agent_proto_msgTypes[35].OneofWrappers = []any{
		(*UploadLibraryRequest_Begin)(nil),
		(*UploadLibraryRequest_Chunk)(nil),
		(*UploadLibraryRequest_Finish)(nil),
	}
	file_nodal_agent_v1_agent_proto_msgTypes[45].OneofWrappers = []any{
