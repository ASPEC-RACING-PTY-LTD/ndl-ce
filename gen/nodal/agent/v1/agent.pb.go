...
var file_nodal_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_nodal_agent_v1_agent_proto_goTypes = []any{
	...
	(*GPUAssign)(nil),             // 19: nodal.agent.v1.GPUAssign
	(*ZFSPool)(nil),               // 20: nodal.agent.v1.ZFSPool
	(*BackupCopy)(nil),            // 21: nodal.agent.v1.BackupCopy
	(*VMSnapshot)(nil),            // 22: nodal.agent.v1.VMSnapshot
	(*VMPrepare)(nil),             // 23: nodal.agent.v1.VMPrepare
	(*VMLifecycle)(nil),           // 24: nodal.agent.v1.VMLifecycle
	(*VMQueryPCI)(nil),            // 25: nodal.agent.v1.VMQueryPCI
	(*QemuProtoStart)(nil),        // 26: nodal.agent.v1.QemuProtoStart
	(*QemuProtoStop)(nil),         // 27: nodal.agent.v1.QemuProtoStop
	(*QemuProtoStatus)(nil),       // 28: nodal.agent.v1.QemuProtoStatus
	(*CTCreate)(nil),              // 29: nodal.agent.v1.CTCreate
	(*CTLifecycle)(nil),           // 30: nodal.agent.v1.CTLifecycle
	(*WorkloadHint)(nil),          // 31: nodal.agent.v1.WorkloadHint
	(*Ping)(nil),                  // 32: nodal.agent.v1.Ping
	(*CreateDirectoryPool)(nil),   // 33: nodal.agent.v1.CreateDirectoryPool
	(*CreateDirectoryVolume)(nil), // 34: nodal.agent.v1.CreateDirectoryVolume
	(*NetDryRun)(nil),             // 35: nodal.agent.v1.NetDryRun
	(*NetApply)(nil),              // 36: nodal.agent.v1.NetApply
	(*ExecuteResponse)(nil),       // 37: nodal.agent.v1.ExecuteResponse
	(*UploadLibraryRequest)(nil),  // 38: nodal.agent.v1.UploadLibraryRequest
	(*UploadLibraryBegin)(nil),    // 39: nodal.agent.v1.UploadLibraryBegin
	(*UploadLibraryFinish)(nil),   // 40: nodal.agent.v1.UploadLibraryFinish
	(*UploadLibraryResponse)(nil), // 41: nodal.agent.v1.UploadLibraryResponse
	(*EnrollRequest)(nil),         // 42: nodal.agent.v1.EnrollRequest
	(*EnrollResponse)(nil),        // 43: nodal.agent.v1.EnrollResponse
	(*OpenSessionRequest)(nil),    // 44: nodal.agent.v1.OpenSessionRequest
	(*OpenSessionResponse)(nil),   // 45: nodal.agent.v1.OpenSessionResponse
	(*FilesOpRequest)(nil),        // 46: nodal.agent.v1.FilesOpRequest
	(*FilesOpResponse)(nil),       // 47: nodal.agent.v1.FilesOpResponse
	(*FilesPutRequest)(nil),       // 48: nodal.agent.v1.FilesPutRequest
	(*FilesPutBegin)(nil),         // 49: nodal.agent.v1.FilesPutBegin
	(*FilesPutFinish)(nil),        // 50: nodal.agent.v1.FilesPutFinish
	(*FilesGetRequest)(nil),       // 51: nodal.agent.v1.FilesGetRequest
	(*FilesGetResponse)(nil),      // 52: nodal.agent.v1.FilesGetResponse
	(*TermFrame)(nil),             // 53: nodal.agent.v1.TermFrame
}
var file_nodal_agent_v1_agent_proto_depIdxs = []int32{
	...
	31, // 3: nodal.agent.v1.ObserveRequest.workloads:type_name -> nodal.agent.v1.WorkloadHint
	31, // 4: nodal.agent.v1.GetWorkloadsRequest.workloads:type_name -> nodal.agent.v1.WorkloadHint
	...
	32, // 7: nodal.agent.v1.ExecuteRequest.ping:type_name -> nodal.agent.v1.Ping
	33, // 8: nodal.agent.v1.ExecuteRequest.create_directory_pool:type_name -> nodal.agent.v1.CreateDirectoryPool
	34, // 9: nodal.agent.v1.ExecuteRequest.create_directory_volume:type_name -> nodal.agent.v1.CreateDirectoryVolume
	35, // 10: nodal.agent.v1.ExecuteRequest.net_dry_run:type_name -> nodal.agent.v1.NetDryRun
	36, // 11: nodal.agent.v1.ExecuteRequest.net_apply:type_name -> nodal.agent.v1.NetApply
	29, // 12: nodal.agent.v1.ExecuteRequest.ct_create:type_name -> nodal.agent.v1.CTCreate
	30, // 13: nodal.agent.v1.ExecuteRequest.ct_lifecycle:type_name -> nodal.agent.v1.CTLifecycle
	26, // 14: nodal.agent.v1.ExecuteRequest.qemu_proto_start:type_name -> nodal.agent.v1.QemuProtoStart
	27, // 15: nodal.agent.v1.ExecuteRequest.qemu_proto_stop:type_name -> nodal.agent.v1.QemuProtoStop
	28, // 16: nodal.agent.v1.ExecuteRequest.qemu_proto_status:type_name -> nodal.agent.v1.QemuProtoStatus
	23, // 17: nodal.agent.v1.ExecuteRequest.vm_prepare:type_name -> nodal.agent.v1.VMPrepare
	24, // 18: nodal.agent.v1.ExecuteRequest.vm_lifecycle:type_name -> nodal.agent.v1.VMLifecycle
	25, // 19: nodal.agent.v1.ExecuteRequest.vm_query_pci:type_name -> nodal.agent.v1.VMQueryPCI
	22, // 20: nodal.agent.v1.ExecuteRequest.vm_snapshot:type_name -> nodal.agent.v1.VMSnapshot
	21, // 21: nodal.agent.v1.ExecuteRequest.backup_copy:type_name -> nodal.agent.v1.BackupCopy
	18, // 22: nodal.agent.v1.ExecuteRequest.host_update:type_name -> nodal.agent.v1.HostUpdate
	19, // 23: nodal.agent.v1.ExecuteRequest.gpu_assign:type_name -> nodal.agent.v1.GPUAssign
	20, // 24: nodal.agent.v1.ExecuteRequest.zfs_pool:type_name -> nodal.agent.v1.ZFSPool
	39, // 25: nodal.agent.v1.UploadLibraryRequest.begin:type_name -> nodal.agent.v1.UploadLibraryBegin
	40, // 26: nodal.agent.v1.UploadLibraryRequest.finish:type_name -> nodal.agent.v1.UploadLibraryFinish
	0,  // 27: nodal.agent.v1.EnrollResponse.host_platform:type_name -> nodal.agent.v1.HostPlatform
	49, // 28: nodal.agent.v1.FilesPutRequest.begin:type_name -> nodal.agent.v1.FilesPutBegin
	50, // 29: nodal.agent.v1.FilesPutRequest.finish:type_name -> nodal.agent.v1.FilesPutFinish
	...
	17, // 32: nodal.agent.v1.AgentService.Execute:input_type -> nodal.agent.v1.ExecuteRequest
	42, // 33: nodal.agent.v1.AgentService.Enroll:input_type -> nodal.agent.v1.EnrollRequest
	44, // 34: nodal.agent.v1.AgentService.OpenSession:input_type -> nodal.agent.v1.OpenSessionRequest
	...
	13, // 37: nodal.agent.v1.AgentService.GetStorage:input_type -> nodal.agent.v1.GetStorageRequest
	15, // 38: nodal.agent.v1.AgentService.GetNetworks:input_type -> nodal.agent.v1.GetNetworksRequest
	7,  // 39: nodal.agent.v1.AgentService.GetWorkloads:input_type -> nodal.agent.v1.GetWorkloadsRequest
	38, // 40: nodal.agent.v1.AgentService.UploadLibrary:input_type -> nodal.agent.v1.UploadLibraryRequest
	46, // 41: nodal.agent.v1.AgentService.FilesOp:input_type -> nodal.agent.v1.FilesOpRequest
	48, // 42: nodal.agent.v1.AgentService.FilesPut:input_type -> nodal.agent.v1.FilesPutRequest
	51, // 43: nodal.agent.v1.AgentService.FilesGet:input_type -> nodal.agent.v1.FilesGetRequest
	53, // 44: nodal.agent.v1.AgentService.AttachTerminal:input_type -> nodal.agent.v1.TermFrame
	2,  // 45: nodal.agent.v1.AgentService.Hello:output_type -> nodal.agent.v1.HelloResponse
	6,  // 46: nodal.agent.v1.AgentService.Observe:output_type -> nodal.agent.v1.ObserveResponse
	37, // 47: nodal.agent.v1.AgentService.Execute:output_type -> nodal.agent.v1.ExecuteResponse
	43, // 48: nodal.agent.v1.AgentService.Enroll:output_type -> nodal.agent.v1.EnrollResponse
	45, // 49: nodal.agent.v1.AgentService.OpenSession:output_type -> nodal.agent.v1.OpenSessionResponse
	10, // 50: nodal.agent.v1.AgentService.GetInventory:output_type -> nodal.agent.v1.GetInventoryResponse
	12, // 51: nodal.agent.v1.AgentService.GetMetrics:output_type -> nodal.agent.v1.GetMetricsResponse
	14, // 52: nodal.agent.v1.AgentService.GetStorage:output_type -> nodal.agent.v1.GetStorageResponse
	16, // 53: nodal.agent.v1.AgentService.GetNetworks:output_type -> nodal.agent.v1.GetNetworksResponse
	8,  // 54: nodal.agent.v1.AgentService.GetWorkloads:output_type -> nodal.agent.v1.GetWorkloadsResponse
	41, // 55: nodal.agent.v1.AgentService.UploadLibrary:output_type -> nodal.agent.v1.UploadLibraryResponse
	47, // 56: nodal.agent.v1.AgentService.FilesOp:output_type -> nodal.agent.v1.FilesOpResponse
	47, // 57: nodal.agent.v1.AgentService.FilesPut:output_type -> nodal.agent.v1.FilesOpResponse
	52, // 58: nodal.agent.v1.AgentService.FilesGet:output_type -> nodal.agent.v1.FilesGetResponse
	53, // 59: nodal.agent.v1.AgentService.AttachTerminal:output_type -> nodal.agent.v1.TermFrame
...
func file_nodal_agent_v1_agent_proto_init() {
	...
	file_nodal_agent_v1_agent_proto_msgTypes[38].OneofWrappers = []any{
